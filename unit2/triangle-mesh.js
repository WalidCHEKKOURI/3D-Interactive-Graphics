...
function drawSquare(x1, y1, x2, y2) //example drawSquare(3,5,7,9);
{
...
window.onload = function() {
    try {
    	...
    	var triangleMaterial = new THREE.MeshBasicMaterial( { color: 0x8E44AD, side: THREE.DoubleSide } );
    	...
    	var square_material = new THREE.MeshBasicMaterial( { color: 0x48C9B0, side: THREE.DoubleSide } );
