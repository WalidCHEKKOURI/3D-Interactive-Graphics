...
function createBall() {
	...
	//var material = new THREE.MeshLambertMaterial( { color: 0x55f026, shading: THREE.FlatShading } ); //uses flat shading
	var material = new THREE.MeshLambertMaterial( { color: 0x55f026 } ); 
    var ka = 0.1;
